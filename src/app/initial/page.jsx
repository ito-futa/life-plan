      ...
      <div className={styles.initial}>
        ...
        <div>
          ...
          <select name="your_age">
            ...
            <option value="16">16</option>歳
            <option value="17">17</option>歳
            <option value="18">18</option>歳
            <option value="19">19</option>歳
            <option value="20">20</option>歳
            <option value="21">21</option>歳
            <option value="22">22</option>歳
            <option value="23">23</option>歳
            <option value="24">24</option>歳
            <option value="25">25</option>歳
            <option value="26">26</option>歳
            <option value="27">27</option>歳
            <option value="28">28</option>歳
            <option value="29">29</option>歳
            <option value="30">30</option>歳
            <option value="31">31</option>歳
            <option value="32">32</option>歳
            <option value="33">33</option>歳
            <option value="34">34</option>歳
            <option value="35">35</option>歳
            <option value="36">36</option>歳
            <option value="37">37</option>歳
            <option value="38">38</option>歳
            <option value="39">39</option>歳
            <option value="40">40</option>歳
            <option value="41">41</option>歳
            <option value="42">42</option>歳
            <option value="43">43</option>歳
            <option value="44">44</option>歳
            <option value="45">45</option>歳
            <option value="46">46</option>歳
            <option value="47">47</option>歳
            <option value="48">48</option>歳
            <option value="49">49</option>歳
            <option value="50">50</option>歳
            <option value="51">51</option>歳
            <option value="52">52</option>歳
            <option value="53">53</option>歳
            <option value="54">54</option>歳
            <option value="55">55</option>歳
            <option value="56">56</option>歳
            <option value="57">57</option>歳
            <option value="58">58</option>歳
            <option value="59">59</option>歳
            <option value="60">60</option>歳
            <option value="61">61</option>歳
            <option value="62">62</option>歳
            <option value="63">63</option>歳
            <option value="64">64</option>歳
            <option value="65">65</option>歳
            <option value="66">66</option>歳
            <option value="67">67</option>歳
            <option value="68">68</option>歳
            <option value="69">69</option>歳
            <option value="70">70</option>歳
            <option value="71">71</option>歳
            <option value="72">72</option>歳
            <option value="73">73</option>歳
            <option value="74">74</option>歳
            <option value="75">75</option>歳
          </select>
        </div>
